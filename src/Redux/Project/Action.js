...
import { ACCEPT_INVITATION_PROJECT_REQUEST, ACCEPT_INVITATION_PROJECT_SUCCESS, CREATE_PROJECT_REQUEST, CREATE_PROJECT_SUCCESS, DELETE_PROJECT_REQUEST, DELETE_PROJECT_SUCCESS, FETCH_PROJECTS_REQUEST, FETCH_PROJECTS_SUCCESS, FETCH_PROJECT_BY_ID_REQUEST, FETCH_PROJECT_BY_ID_SUCCESS, INVITE_TO_PROJECT_REQUEST, INVITE_TO_PROJECT_SUCCESS, SEARCH_PROJECT_REQUEST, SEARCH_PROJECT_SUCCESS } from "./ActionType";
...
export const acceptInvitation=({token,navigate})=>async(dispatch)=>{
  ...
  try{
    ...
    console.log("accept project invitation",data);
